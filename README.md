# restbase-mod-table-isekai-mysql [![Build Status](https://travis-ci.org/wikimedia/restbase-mod-table-isekai-mysql.svg?branch=master)](https://travis-ci.org/wikimedia/restbase-mod-table-isekai-mysql)
